...
**_ 1) window.history.pushState(stateObject,title,url ) _**
...
**_ 2) window.history.replaceState(stateObject,title,url) _**
...
**_ 两者区别：pushState 会改变 history.length，而 replaceState 不改变 history.length _**
